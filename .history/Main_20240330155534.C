...
int main() {
    ...
    char*** data = (char***)malloc(rows * sizeof(char**)); // Declares a pointer to a pointer to a pointer to a char, there are three astrisks which corresponds to the 3 dimensions in the array
