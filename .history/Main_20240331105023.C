...
void hottestColdestYear() {
    FILE *q1ValuesRead = fopen("q1.txt", "r");
    FILE *q1Values
    if (q1Values == NULL) {
    ...
    fprintf("The hottest year is %d, with a temperature of %f\n", highYear, highTemp);
    fprintf("The hottest year is %d, with a temperature of %f", lowYear, lowTemp);
