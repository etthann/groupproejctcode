...
plot 'q8.txt' using ($1 >= 1850 && $1 < 2015 ? $1 : 1/0):2 title "Land Average" with lines lw 2 lc rgb 'blue' , \
     'q8.txt' using ($1 >= 1850 && $1 <= 2015 ? $1 : 1/0):3 "Land Max" with lines lw 2 lc rgb 'red' title , \
     'q8.txt' using ($1 >= 1850 && $1 < 2015 ? $1 : 1/0):4 "Land Minimum" with lines lw 2 lc rgb 'green' title 