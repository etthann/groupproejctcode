...
plot 'q1.txt' using ($1 >= 1800 && $1 < 1900 ? $1 : 1/0):2 title "19th Century" with lines lw 3 lc rgb 'blue' , \
     'q1.txt' using ($1 >= 1900 && $1 <= 2000 ? $1 : 1/0):2 title "20th Century" with lines lw 2 lc rgb 'red'    