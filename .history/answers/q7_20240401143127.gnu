...
I = {0.0, 1.0}
VoxelDistance = 0.0
plot 'q1.txt' using ($1 >= 1800 && $1 < 1900 ? $1 : 1/0):2 with lines lw 2 lc rgb 'blue' title "19th Century", 'q1.txt' using ($1 >= 1900 && $1 <= 2000 ? $1 : 1/0):2 with lines lw 2 lc rgb 'red' title "20th Century"
#    EOF