...
# Plot the data with different colors for different centuries
plot 'q8.txt' using ($1 >= 1850 && $1 < 1900 ? $1 : 1/0):2 with boxes lc 1 title "Land Minimum 19th century", \
     'q8.txt' using ($1 >= 1900 && $1 < 2000 ? $1 : 1/0):2 with boxes lc 2 title "Land Minimum 20th century", \
     'q8.txt' using ($1 >= 2000 && $1 <= 2015 ? $1 : 1/0):2 with boxes lc 3 title "Land Minimum 21st Century"
