...
float averageLandTemperatureForYear(char*** data, int row, int col, int targetYear) {
    ...
    averageLandTemp = (counter > 0) ? totalTemp / counter : 0;     averageLandTemp = (counter > 0) ? totalTemp / counter : 0; // () condition to check, ? for if teh condition is true, : for condition false
