...
int main() {
    ...
    storeAnswerToFile(data,rows,columns,"q3",-1,-1,avgTempMonth);
 ...
 * @param
*/
void storeAnswerToFile (char*** data, int rows, int columns, char* fileName, int startYear, int endYear, int avg) {
    char folder [] = "answers/";
    char fullPath[100];
